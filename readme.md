...
This repo is part of a project examining and evaluating different workflow managers by re-factoring an analysis workflow. This repo contains the re-implementation in [`GNU Make`](https://www.gnu.org/software/make/).
...
### To-Do
- [ ] implement all recipes to reproduce workflow 
